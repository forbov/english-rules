...
from schools.models import School, SchoolTeacher
...
class Invitation(models.Model):
  ...
  school_teacher = models.ForeignKey(SchoolTeacher, related_name='invited_students', on_delete=models.CASCADE, null=True)
